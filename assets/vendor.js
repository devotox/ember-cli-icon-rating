...
Object.defineProperty(e,"__esModule",{value:!0})
var r=Ember.Component,n=function(e){return e.charAt(0).toUpperCase()+e.slice(1)},i=function(e,t){for(var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:1,n=[],i=e<t,o=!(arguments.length>3&&void 0!==arguments[3])||arguments[3]?i?t+1:t-1:t,a=e;i?a<o:a>o;i?a+=r:a-=r)n.push(a)
return n}
e.default=r.extend({layout:t.default,min:1,max:5,step:1,value:0,width:0,hover:0,size:"lg",icon:null,color:null,readOnly:!1,baseIcon:"star",fillIcon:"star",disableHover:!1,fillColor:"#FFD700",baseColor:"#BDBDBD",showRatingAbove:!1,showRatingBelow:!1,iconComponent:"fa-icon",init:function(){this._super.apply(this,arguments)
var e=this.get("min"),t=this.get("max"),r=this.get("step")
this.set("icons",i(e,t,r,!0))},didReceiveAttrs:function(){this.setupProp("icon"),this.setupProp("color")},setupProp:function(e){var t=this.get(e),r=n(e)
t&&this.set("base"+r,t)&&this.set("fill"+r,t)},actions:{clickHandler:function(e){!this.get("readOnly")&&this.sendAction("onClick",e)},mouseEnterHandler:function(e){!this.get("readOnly")&&!this.get("disableHover")&&this.set("hover",e)},mouseLeaveHandler:function(){!this.get("readOnly")&&!this.get("disableHover")&&this.set("hover",0)}}})}),define("ember-cli-icon-rating/templates/components/icon-rating",["exports"],function(e){"use strict"
